...
public class UploadFileRequestInNewsFeeds extends MasterRequest{
	...
	protected String insertNewDocumentAsByteArray(ModelUploadFileRequestInNewsFeeds fileRequest) {

		try {
				ByteArrayInputStream bis = new ByteArrayInputStream(fileRequest.getFileBinary());
				ContentBody fileBody = new InputStreamBody(bis, fileRequest.getFileName());
